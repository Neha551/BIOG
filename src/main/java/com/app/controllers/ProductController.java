...
//*******************************  CORE(13) *******************************************
		...
		case ProductConstants.ACC_CASE:
			...
			try {
				List<Product> caseAcc = caseAccService.getAllCaseAccessory();
				// non empty list
		...
		case ProductConstants.ACC_FAN_CONTROLLER:
			...
			try {
				List<Product> fanController = fanControllerAccService.getAllFanControllerAccessory();
				// non empty list
		...
		case ProductConstants.ACC_THERMAL_COMPOUND:
			...
			try {
				List<Product> thermalAcc = thermalAccService.getAllThermalCompoundAccessory();
				// non empty list
		...
		case ProductConstants.ACC_UPS:
			...
			try {
				List<Product> upsAcc = upsAccService.getAllUPSAccessory();
				// non empty list
		...
		case ProductConstants.ACC_CASE_FAN:
			...
			try {
				List<Product> caseFanAcc = caseFanAccService.getAllCaseFanAccessory();
				// non empty list
		...
		case ProductConstants.NW_SOUND_CARD:
			...
			try {
				List<Product> soundCard = soundCardService.getAllSoundCards();
				// non empty list
		...
		case ProductConstants.NW_WIRED_CARD:
			...
			try {
				List<Product> wired = wiredService.getAllWiredNetworkAdapters();
				// non empty list
		...
		case ProductConstants.NW_WIRELESS_CARD:
			...
			try {
				List<Product> wireless = wirelessService.getAllWireLessNetworkAdapters();
				// non empty list
		...
		case ProductConstants.PERI_HEADPHONES:
			...
			try {
				List<Product> headphone = headphoneService.getAllHeadphones();
				// non empty list
		...
		case ProductConstants.PERI_KEYBOARD:
			...
			try {
				List<Product> keyboard = keyboardService.getAllKeyboard();
				// non empty list
		...
		case ProductConstants.PERI_MICE:
			...
			try {
				List<Product> mice = miceService.getAllMice();
				// non empty list
		...
		case ProductConstants.PERI_SPEAKER:
			...
			try {
				List<Product> speaker = speakerService.getAllSpeakers();
				// non empty list
		...
		case ProductConstants.PERI_WEBCAM:
			...
			try {
				List<Product> webcam = webcamService.getAllWebcams();
				// non empty list
