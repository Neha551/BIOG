...
public class OpticalDrive extends Product{
	...
	public OpticalDrive(int id, int bluRayDisc, int dvd, int cd, String bdWrite, String dvdWrite, String cdWrite,String name, String manufacturer, String brand, float price, boolean isAvailable) {
